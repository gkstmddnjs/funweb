...
<body>
	...
	<%
		...
		//BoardBean객체의 각 변수에 저장 (자바코드 or Action태그 이용)
	%>
	...
	<%
		//4. 수정을 위해 입력한 정보가 담긴 BoardBean객체를 boardDAO객체의 updateBoard()메소드 호출시 매개변수로 전달 후 UPDATE작성 명령함!
		//	수정에 성공하면 1을 반환받고 수정에 실패하면 0반환 받아 int check 변수에 저장
	...
	%>
					...
					<script type="text/javascript">
						...
						window.alert("수정실패!");
						history.go(-1); //update.jsp로 가서 비밀번호 다시 입력하기
